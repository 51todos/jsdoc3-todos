...
var Manager = function () {
  ...
  createClass(Manager, [{
    ...
    /**
     * privatexxx-ddd-fff add a recognizer to the manager
    ...
    /**
     * privatexxx-ddd-fff unbind event, leave emit blank to remove all handlers
     * @param {String} events
     * @param {Function} [handler]
     * @returns {EventEmitter} this
     */
    ...
    /**
     * privatexxx-ddd-fff emit event to the listeners
     * @param {String} event
     * @param {Object} data
     */
